...
// Fetch sidebar statistics for IT staff (assigned tickets specific)
$stats_sql = "
    SELECT 
    ...
    <ul class="sidebar-menu">
      ...
      <li class="sidebar-section">
        ...
        <ul>
          ...
          <li class="sidebar-item">
            <a href="it-assigned-tickets.php" class="sidebar-link active">
 ...
 <!-- Main Content -->
  ...
  <section>
    ...
    $tableConfigCustom = [
        ...
        'showPriority' => true,
        'showStatus' => true,
        'actionButtons' => ['view', 'in-progress', 'resolve', 'add-note', 'pending'],
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (tickets.length === 0) {
    Swal.fire({
      ...
      text: 'You don\'t have any assigned tickets yet!',
      icon: 'info',
      timer: 3000,
