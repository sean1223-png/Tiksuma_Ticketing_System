...
// Fetch assigned resolved tickets
$sql = "
    ...
    WHERE t.assigned_to = ? AND s.status_name = 'Resolved'
...
// Fetch resolved ticket notifications
$notif_sql = "
    ...
    WHERE ticket_statuses.status_name = 'Resolved'
...
// Count of new resolved tickets for bell badge
$new_ticket_count_sql = "
    SELECT COUNT(*) AS new_count
    FROM tickets
    WHERE status_id = (SELECT id FROM ticket_statuses WHERE status_name='Resolved')
";
$new_ticket_count = $conn->query($new_ticket_count_sql)->fetch_assoc()['new_count'];

// Fetch sidebar statistics for IT staff (resolved tickets specific)
$stats_sql = "
    SELECT 
...
<div class="topbar-right">
    <div class="notification-container" style="position: relative;">
      ...
      <div class="notification-dropdown" id="notificationDropdown">
        ...
        <div class="notif-title">Resolved Ticket*</div>
        ...
        <?php else: ?>
          <p class="notif-empty">No resolved tickets.</p>
        <?php endif; ?>
      </div>
    </div>
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="sidebar-section">
        ...
        <ul>
          ...
          <li class="sidebar-item">
            <a href="it-resolved.php" class="sidebar-link active">
              <i class="fas fa-check-circle"></i>
              <span>Resolved</span>
              <span class="sidebar-badge"><?= $stats['resolved_count'] ?></span>
  ...
  <section>
    ...
    $tableConfigCustom = [
        ...
        'showPriority' => true,
        'showStatus' => true,
        'actionButtons' => ['view', 'add-note', 'archive'],
