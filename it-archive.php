...
// Fetch assigned archived tickets
$sql = "
    ...
    WHERE t.assigned_to = ? AND s.status_name = 'Archived'
...
// Fetch archived ticket notifications
$notif_sql = "
    ...
    WHERE ticket_statuses.status_name = 'Archived'
...
// Count of new archived tickets for bell badge
$new_ticket_count_sql = "
    SELECT COUNT(*) AS new_count
    FROM tickets
    WHERE status_id = (SELECT id FROM ticket_statuses WHERE status_name='Archived')
";
$new_ticket_count = $conn->query($new_ticket_count_sql)->fetch_assoc()['new_count'];

// Fetch sidebar statistics for IT staff (archived tickets specific)
$stats_sql = "
    SELECT 
...
<head>
  ...
  <title>TIKSUMA Archived Tickets</title>
...
<div class="topbar-right">
    <div class="notification-container" style="position: relative;">
      ...
      <div class="notification-dropdown" id="notificationDropdown">
        ...
        <div class="notif-title">Archived Ticket*</div>
        ...
        <?php else: ?>
          <p class="notif-empty">No archived tickets.</p>
        <?php endif; ?>
      </div>
    </div>
    ...
    <ul class="sidebar-menu">
      ...
      <li class="sidebar-section">
        ...
        <ul>
          ...
          <li class="sidebar-item">
            <a href="it-archive.php" class="sidebar-link active">
              <i class="fas fa-archive"></i>
              <span>Archive</span>
              <span class="sidebar-badge"><?= $stats['archived_count'] ?></span>
            </a>
          </li>
        </ul>
      </li>
...
<div class="main-content">
  <section>
    ...
    $tableConfigCustom = [
        ...
        'showPriority' => true,
        'showStatus' => true,
        'actionButtons' => ['view', 'restore', 'add-note', 'pending'],
