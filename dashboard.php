...
<div class="sidebar" id="sidebar">
  <ul>
    ...
    <li><a href="user-ticket.php"><i class="fas fa-envelope-open-text"></i> User Ticket Submit</a></li>
    <li><a href="archive.php"><i class="fas fa-archive"></i> Archive Tickets</a></li>
    <li><a href="users.php"><i class="fas fa-users"></i> Users</a></li>
    <li><a href="reports.php"><i class="fas fa-file-alt"></i> Ticket Reports</a></li>
  </ul>
