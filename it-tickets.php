...
$defaultProfile = 'data:image/svg+xml;base64,' . base64_encode('<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><circle cx="50" cy="50" r="50" fill="#ccc"/><circle cx="50" cy="35" r="15" fill="#999"/><path d="M20 80 Q20 60 50 60 Q80 60 80 80" fill="#999"/></svg>');
$profilePicture = $defaultProfile;
if ($user_result && $user_result->num_rows > 0) {
    $user_data = $user_result->fetch_assoc();
    $profilePicture = $user_data['profile_picture'] ?: $defaultProfile;
}
$stmt->close();

// Fetch tickets list
$sql = "
    SELECT t.ticket_id, u.username, t.subject, t.description,
...
// Fetch accepted ticket notifications
$notif_sql = "
...
// Fetch sidebar statistics for IT staff
$stats_sql = "
    SELECT 
...
<head>
  ...
  <title>IT Dashboard - TIKSUMA</title>
   ...
   <div class="topbar-right">
    <div class="notification-container" style="position: relative;">
      ...
      <div class="notification-dropdown" id="notificationDropdown">
        ...
        <div class="notif-title">New Ticket*</div>
        ...
        <?php else: ?>
          <p class="notif-empty">No new tickets.</p>
        <?php endif; ?>
      </div>
    </div>
    ...
    <ul class="sidebar-menu">
      ...
      <li class="sidebar-section">
        ...
        <ul>
          ...
          <li class="sidebar-item">
            <a href="it-tickets.php" class="sidebar-link active">
 ...
 <!-- Main Content -->
  ...
  <section>
    ...
    $tableConfigCustom = [
        ...
        'showPriority' => true,
        'showStatus' => true,
        'actionButtons' => ['view', 'assign', 'add-note'],
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script>
// Auto-check for new ticket count every 15 seconds
setInterval(() => {
