...
// Fetch assigned in-progress tickets
$sql = "
    ...
    WHERE t.assigned_to = ? AND s.status_name = 'In Progress'
...
// Fetch in-progress ticket notifications
$notif_sql = "
    ...
    WHERE ticket_statuses.status_name = 'In Progress'
...
// Count of new in-progress tickets for bell badge
$new_ticket_count_sql = "
    SELECT COUNT(*) AS new_count
    FROM tickets
    WHERE status_id = (SELECT id FROM ticket_statuses WHERE status_name='In Progress')
";
$new_ticket_count = $conn->query($new_ticket_count_sql)->fetch_assoc()['new_count'];

// Fetch sidebar statistics for IT staff (in-progress tickets specific)
$stats_sql = "
    SELECT
...
<head>
  ...
  <title>TIKSUMA Dashboard - In Progress Tickets</title>
...
<div class="topbar-right">
    <div class="notification-container" style="position: relative;">
      ...
      <div class="notification-dropdown" id="notificationDropdown">
        ...
        <div class="notif-title">In Progress Ticket*</div>
            ...
            <?php foreach ($notifications as $note): ?>
              <li class="notif-item">
                ...
                <div class="notif-content">
                  <span class="badge status-in-progress"><?= htmlspecialchars($note['status_name']) ?></span>
                </div>
              </li>
            <?php endforeach; ?>
          </ul>
        <?php else: ?>
          <p class="notif-empty">No in-progress tickets.</p>
        <?php endif; ?>
      </div>
    </div>
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="sidebar-section">
        ...
        <ul>
          ...
          <li class="sidebar-item">
            <a href="it-in_progress.php" class="sidebar-link active">
              <i class="fas fa-hourglass-half"></i> 
              <span>In Progress</span>
              <span class="sidebar-badge"><?= $stats['in_progress_count'] ?></span>
            </a>
          </li>
          <li class="sidebar-item">
  ...
  <div class="main-content">
    ...
    $tableConfigCustom = [
        ...
        'showPriority' => true,
        'showStatus' => true,
        'actionButtons' => ['view', 'resolve', 'add-note', 'pending'],
        'emptyMessage' => 'No in-progress tickets found.',
        'printButton' => true,
        'searchBox' => true
    ];
